...
- Code in [Monaspace Argon](). This is part of the suite of fonts developed by Github Next. It's also the primary font I use locally in my IDE. It's a Humanist Sans font (I have tried to use Serifed fonts for coding, but it just looks utterly wrong to me).
- Math in [Neo-Euler](). When I use math, I want it to stand out as distinct from the surrounding text. I think Neo-Euler does a good job of walking the line between being a little weird and being easy to read.
...
To use the custom fonts I want without screwing with performance too much, I used [the solution detailed here](https://css-tricks.com/how-to-load-fonts-in-a-way-that-fights-fout-and-makes-lighthouse-happy/) to make sure fonts can be preloaded and also that they aren't part of the critical path for rendering.
