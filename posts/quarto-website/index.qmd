...
description: |
    I continue my long search for a system that will allow me to generate a nicely formatted
    website with publication list based on adding publications to a single source of truth
